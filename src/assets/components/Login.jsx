        ...
        <div class="App">
          <div className="auth-form-container">
              ...
              <form className="login-form" onSubmit={handleSubmit}>
                  ...
                  <button class="my-3 focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900" type="submit">Log In</button>
              </form>
